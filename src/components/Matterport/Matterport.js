    ...
    <div className="matterport" id="matterport">
      <div className="matterport__container">
        ...
        <p>
          ...
          physical spaces. With Matterport's technology, we were able to provide
          potential residents <br /> with a more realistic and comprehensive
          representation of the dorm rooms, which can help <br /> them make more
          informed decisions before moving in.
        </p>
